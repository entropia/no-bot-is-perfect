...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bot.explaining'
        db.add_column(u'nbip_bot', 'explaining',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['nbip.Word'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bot.explaining'
        db.delete_column(u'nbip_bot', 'explaining_id')
