...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BotStats'
        db.create_table(u'nbip_botstats', (
            ('bot', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['nbip.Bot'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'nbip', ['BotStats'])


    def backwards(self, orm):
        # Deleting model 'BotStats'
        db.delete_table(u'nbip_botstats')
    ...
    models = {
        ...
        u'nbip.bot': {
            ...
            'apikey': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'explaining': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['nbip.Word']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bots'", 'to': u"orm['auth.User']"})
        },
        u'nbip.botstats': {
            'Meta': {'object_name': 'BotStats'},
            'bot': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['nbip.Bot']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'nbip.gameroundentry': {
            ...
            'gameround': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entries'", 'to': u"orm['nbip.GameRound']"}),
            'guess': ('nbip.models.GuessField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pos': ('django.db.models.fields.PositiveSmallIntegerField', [], {})
        },
