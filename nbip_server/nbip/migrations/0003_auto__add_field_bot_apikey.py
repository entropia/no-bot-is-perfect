...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bot.apikey'
        db.add_column(u'nbip_bot', 'apikey',
                      self.gf('django.db.models.fields.CharField')(default='foo', unique=True, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bot.apikey'
        db.delete_column(u'nbip_bot', 'apikey')
